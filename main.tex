...
The expected dark noise rate from the MPPCs in the VIDARR detector is 15kHz [citation needed], this rate can be increased or decreased depending on incoming data. The dark noise for one MPPC may be different than the collective dark noise for 2660 MPPCs, the full dark noise of the detector therefore may need to be that averaged in order to get a proper representation of the dark noise in the VIDARR detector. 
