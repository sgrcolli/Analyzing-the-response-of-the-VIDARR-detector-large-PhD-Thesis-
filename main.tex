...
\subsection{Loss of Detected Energy due to Quenching}
The light and subsequent energy produced from the approximation in equation \ref{MeV_electron_equivalent_light} is then compared to the energy without quenching effects. This effect has been characterised up to 100\,MeV, however, the energy range that is most relevant to this experiment is 0-10\,MeV 
