...
Both the VIDARR and Minerva approach use the Geant4 bertini cascade model when attempting to measure the Birks parameter $kB$ \cite{Geant4_bert_cas}. The results of the minerva Birks law investigation can be seen in figure \ref{minerva_birks_plot} (needs more explanation and detail)
