...
The effect of quenching on particles scales with rest mass, alpha particles and anti-alpha particles seen in figure \ref{alpha_Aalpha_quenched_and_not} can lose up to 90\,\% of their energy. Again as with protons nearly all energy loss seen is through quenching, a 10\,MeV alpha particle will look similar to the scintillator in VIDARR to a 1\,MeV electron. Figure \ref{electron_positron_quenched_and_not} shows the response of both electrons in \ref{electron_quenched_and_not} and positrons in \ref{positron_quenched_and_not}. Unlike protons, anti-protons or alphas and anti-alphas the response of the electrons is not greatly affected by quenching, but is still non-linear. This is probably due to the electrons losing energy in a statistical or stochastic process known as straggling \cite{rad_det_and_meas}, \cite{electron_straggling01}. Energy straggling for electrons mainly occurs via two methods (i) collisions with atomic electrons (energy losses through ionisation) and (ii) collisions with atomic nuclei (radiative energy losses) \cite{electron_straggling01}. The electrons are not leaving the "slab" of scintillator as shown in figure \ref{electrons_viewed_in_slab}.
...
\section{Attenuation}
The attenuation of the scintillator and the WLS fibres was measured with a physical bar by George Holt, a VIDARR collaborator. The result of this attenuation plot can be seen in figure \ref{Attenuation_plot}, the attenuation length for the setup of the single bar was 5.8\,m $\pm$ 0.6\,m. This attenuation length was then put into the simulation, the distance from the MPPPC is used instead of the Distance from the end of the bar in the simulation. But these two are synonymous. 

\begin{Figure}
 \centering
 \includegraphics[height=90mm]{result_from_attnPlotter.png}
 \captionof{figure}{Attenuation plot of a whole bar including the WLS fibre and the scintillating bar using a CS-137 source the attenuation length is 5.8\,m $\pm$ 0.6\,m from \cite{attenuation_gholt}} %~can be used as a kind of place holder in latex
 \label{Attenuation_plot}
\end{Figure}
...
R.L.Craun D.L.Smith  April 1970, Nuclear Instruments and Methods Volume 80, Issue 2, 15, Pages 239-244, Analysis of response data for several organic scintillators \url{https://www.sciencedirect.com/science/article/pii/0029554X70907688}

\bibitem{electron_straggling01}
Younes Mejaddem et al. February 2001, Nuclear Instruments and Methods in Physics Research Section B: Beam Interactions with Materials and Atoms Volume 173, Issue 4, , Pages 397-410, Calculations of electron energy loss straggling, \url{https://www.sciencedirect.com/science/article/pii/S0168583X00004286}

\bibitem{attenuation_gholt}
George Holt, Jan 2019, private communication
