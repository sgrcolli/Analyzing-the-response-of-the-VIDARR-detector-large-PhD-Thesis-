...
However the light yield for electrons and positrons seen in figure \ref{electron_positron_light} varies more significantly. A variation of  
...
\begin{subfigure}{.5\textwidth}
  ...
  \captionsetup{width=.9\linewidth}
  \caption{electron light produced by Geant4 compared to the square approximation of that light, the simulated light fit is the square funciton $L = aE^2 + bE+ c$ and is fit to the Geant4 simulated light}
  \label{a}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  ...
  \captionsetup{width=.9\linewidth}
  \caption{positron light produced by Geant4 compared to the square approximation of that light, the simulated light fit is the square funciton $L = aE^2 + bE+ c$ and is fit to the Geant4 simulated light}
  \label{b}
\end{subfigure}
\caption{Electron light output compared to the square approximation per Geant 4 step and a square fit to the overall light output in Geant4}
\label{c}
\end{figure}
